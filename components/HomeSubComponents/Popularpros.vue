<template>
    <section class="font-quicksand mt-16 mx-auto w-11/12 lg:w-full lg:max-w-[65rem]">
        <div class="flex justify-between items-center w-full">
            ...
            <nuxt-link to="pros"
                class="flex items-center gap-2 justify-center border rounded-full group border-[#5920BC]  hover:bg-[#5920BC] py-2 px-4 lg:py-3 lg:px-6">
                <p class="text-[#5920BC] group-hover:text-white "> Discover All Pros</p>
                <svg class="group-hover:fill-white" width="18" height="12" viewBox="0 0 18 12" fill="none" xmlns="http://www.w3.org/2000/svg">
